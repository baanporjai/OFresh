// ใช้ไฟล์นี้เฉพาะกรณีอยาก deploy Apps Script แยกเป็นโปรเจกต์ใหม่ต่างหาก (เช่น ใช้สเปรดชีตคนละไฟล์กับออเดอร์ส้ม)
// ถ้าจะเก็บต้นทุน/ค่าใช้จ่ายไว้เป็นอีกแท็บในสเปรดชีตเดียวกับออเดอร์ส้ม (Apps Script ตัวเดียวกัน)
// ให้ใช้โค้ดที่รวมไว้ใน order-sheet-script.gs แทน (มีฟังก์ชัน handleExpenseRequest อยู่ในนั้นแล้ว)
